...
function preload(){
  ...
  trex_running = loadImage("robber-dribbble.gif");
  trex_collided = loadImage("robber-dribbble.gif");
  
  groundImage = loadImage("Untitled.png");
  
  cloudImage = loadImage("cloud.png");
  
  obstacle1 = loadImage("00092233p.webp");
  obstacle2 = loadImage("00092233p.webp");
...
function setup() {
  ...
  ground = createSprite(width/100,540,600,40);
